...
The gap isn't in the tracking — it's in everything that happens before someone enters your pipeline. That's where companies like Motorpoint found they were losing 58% of their time."`}
        ...
        <ScriptBlock label="Wedge: HRIS ATS (ADP / Paycom / BambooHR)">
          {`"You're using ADP's recruiting module — when you evaluate it against a purpose-built ATS, what gaps have you noticed? Most companies I talk to find it handles about 20% of what they actually need for recruiting.
...
I'm not saying ADP is bad. It's great at payroll and compliance. But asking it to also be your recruiting engine is like asking your accountant to run your marketing."`}
        ...
        <ScriptBlock label="Wedge: No ATS / Spreadsheets / Email">
...
At your current volume, every day without a centralized system means candidates are falling through the cracks. And the ones you lose are usually the best ones — because they have options."`}
        ...
        <ScriptBlock label="Wedge: Indeed / LinkedIn Only (No ATS)">
...
Companies using Teamtailor's AI Copilot see a 5.4x higher hire rate from screened candidates — because the AI does in seconds what takes your team hours."`}
        </ScriptBlock>
      </DocSection>
          ...
          <table className="w-full text-sm border-collapse">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="border border-stone-300 px-3 py-2">ATS module built for compliance, not recruiting</td>
                <td className="border border-stone-300 px-3 py-2 italic">{`"What % of recruiting needs does ADP handle?"`}</td>
                <td className="border border-stone-300 px-3 py-2">Purpose-built ATS with full recruitment marketing</td>
              </tr>
              <tr className="bg-stone-50">
                <td className="border border-stone-300 px-3 py-2 font-medium">BambooHR</td>
                <td className="border border-stone-300 px-3 py-2">Basic ATS, no AI, no employer branding tools</td>
              ...
              <tr>
                <td className="border border-stone-300 px-3 py-2 font-medium">No ATS</td>
      ...
      <DocSection title="The HRIS Wedge Play">
        ...
        <ScriptBlock label="The HRIS Wedge Talk Track">
          {`"Here's what I see with companies using [ADP/Paycom/BambooHR] for recruiting: the ATS module was designed to get a new employee into the system once they're hired. It handles compliance — I-9s, onboarding paperwork, payroll setup. But that's the last 5% of recruiting.

The other 95% — attracting candidates, building a career site that converts, screening applications with AI, coordinating interviews with hiring managers, nurturing your talent pool — that's where purpose-built platforms like Teamtailor live.
...
Your HRIS is great at what it does. But asking it to also be your recruiting engine is like asking your accountant to run your marketing. They're both important — they're just different jobs."`}
        ...
        <Callout type="info" title="When to Use the HRIS Wedge">
          Deploy this play the moment you hear ADP, Paycom, BambooHR, Workday Recruiting, UKG, or any HRIS with a bundled ATS module. The 5%/95% framing instantly reframes their tool as insufficient without badmouthing it.
        </Callout>
      </DocSection>
