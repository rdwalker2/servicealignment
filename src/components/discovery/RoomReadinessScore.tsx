...
const READINESS_CHECKS: ReadinessCheck[] = [
  ...
  {
    id: 'ats',
    label: 'Current Provider identified',
    category: 'recommended',
    check: s => !!s.current_ats && s.current_ats !== 'None',
    fixHint: 'Set their current Provider for competitive positioning',
...
export function RoomReadinessModal({ open, onClose, session, shareUrl, onCopyLink }: RoomReadinessProps) {
  ...
  const handleEmailShare = () => {
    const subject = encodeURIComponent(`Service Alignment Discovery Room — ${session.company_name}`);
