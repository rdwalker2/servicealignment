                              ...
                              <>
                                <div className="flex items-center justify-between border-b border-stone-100 pb-6">
                                    <div>
                                        ...
                                        <p className="text-sm text-stone-500">Teamtailor is flat-fee. You save on every manager you add.</p>
                                    </div>
                            ...
                            <div className="flex items-center justify-between border-b border-red-100 pb-6">
                                <div>
                                    ...
                                    <p className="text-sm text-stone-500">
                                        ...
                                        {coiDaysSaved > 0 && ` Teamtailor fills roles ${coiDaysSaved} days faster.`}
                                    </p>
                                </div>
                                <div className="text-right">
