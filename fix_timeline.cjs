...
// Replace the factors logic and UI
const targetStart = "              // Extract Factors";
const targetEnd = "                    </div>\n\n                    <button style={{";
...
const newBlock = `              // Extract Factors
              let age = 15;
              let hasHail = false;
              ...
              return (
                ...
                onMouseLeave={(e) => {
                  ...
                  <div style={{ padding: 24, display: 'flex', flexDirection: 'column', flex: 1 }}>
                    ...
                    {/* Historical Timeline */}
                    <div style={{ backgroundColor: '#fafaf9', borderRadius: 8, padding: '20px 16px', marginBottom: 24, border: '1px solid #e7e5e4' }}>
