export type Company = {
  ...
  employerBrandScore: number; // 1-100 (lower means they desperately need Teamtailor)
...
export const mockDatabase: Company[] = [
  ...
  {
    id: 'c_004', name: 'UNTUCKit', industry: 'Retail', employeeCount: 600, openRoles: 40, hiringVelocityScore: 70, currentAts: 'Workday', employerBrandScore: 50, hq: 'New York, NY', notes: '80+ retail locations.', painPoint: 'Stuck in an expensive Enterprise ATS contract that is overkill for retail store hiring.'
  },
  {
  ...
  // FOOD & HOSPITALITY
  {
    id: 'c_009', name: 'Sweetgreen', industry: 'Food & Beverage', employeeCount: 6000, openRoles: 350, hiringVelocityScore: 99, currentAts: 'Workday', employerBrandScore: 60, hq: 'Los Angeles, CA', notes: 'High volume QSR hiring.', painPoint: 'Complex ATS creates friction for entry-level workers. Need no-login, mobile applications.'
  },
  {
  ...
  {
    id: 'c_014', name: 'Velvet Taco', industry: 'Food & Beverage', employeeCount: 120, openRoles: 14, hiringVelocityScore: 85, currentAts: 'None', employerBrandScore: 40, hq: 'Dallas, TX', notes: 'Late-night premium tacos, ~40 locations. No HR tech stack at all.', painPoint: 'Zero ATS. GMs collect paper applications and text candidates from personal phones. No compliance trail.'
  },
  {
    id: 'c_015', name: 'First Watch', industry: 'Food & Beverage', employeeCount: 10000, openRoles: 220, hiringVelocityScore: 90, currentAts: 'Workday', employerBrandScore: 55, hq: 'Bradenton, FL', notes: 'Daytime cafe.', painPoint: 'Per-seat licensing costs mean shift supervisors cannot access the ATS to review resumes.'
  },
  {
  ...
  {
    id: 'c_018', name: '[solidcore]', industry: 'Fitness & Wellness', employeeCount: 140, openRoles: 16, hiringVelocityScore: 92, currentAts: 'None', employerBrandScore: 50, hq: 'Washington, DC', notes: 'Pilates-inspired fitness, ~100 studios. Using spreadsheets and email for all hiring.', painPoint: 'No ATS at all. Studio managers post to Indeed individually with no coordination. Duplicate candidate outreach is constant.'
  },
  {
    id: 'c_019', name: 'CorePower Yoga', industry: 'Fitness & Wellness', employeeCount: 3000, openRoles: 150, hiringVelocityScore: 88, currentAts: 'Workday', employerBrandScore: 65, hq: 'Denver, CO', notes: 'Largest US yoga chain.', painPoint: 'Studio managers are locked out of the ATS due to licensing costs.'
  },
  {
    id: 'c_020', name: 'Orangetheory', industry: 'Fitness & Wellness', employeeCount: 5000, openRoles: 280, hiringVelocityScore: 96, currentAts: 'Taleo', employerBrandScore: 35, hq: 'Boca Raton, FL', notes: 'Franchise fitness.', painPoint: 'Franchisees need an easy-to-use system, but corporate mandates an outdated enterprise ATS.'
  },
  {
  ...
  {
    id: 'c_030', name: 'Reformation', industry: 'Retail', employeeCount: 1000, openRoles: 90, hiringVelocityScore: 88, currentAts: 'Greenhouse', employerBrandScore: 80, hq: 'Los Angeles, CA', notes: 'Fast-growth sustainable fashion.', painPoint: 'Warehouse and retail hiring are disconnected in current ATS setup.'
  },
  {
  ...
  {
    id: 'c_032', name: 'Sephora', industry: 'Retail', employeeCount: 30000, openRoles: 1500, hiringVelocityScore: 99, currentAts: 'Taleo', employerBrandScore: 75, hq: 'San Francisco, CA', notes: 'LVMH owned.', painPoint: 'Massive seasonal hiring spikes crash their legacy ATS workflows.'
  },
  {
  ...
  {
    id: 'c_047', name: 'Row House', industry: 'Fitness & Wellness', employeeCount: 65, openRoles: 8, hiringVelocityScore: 75, currentAts: 'None', employerBrandScore: 55, hq: 'New York, NY', notes: 'Boutique rowing studios, ~100 locations. Niche fitness concept with tiny corporate team.', painPoint: 'No ATS. Studio owners post to Instagram and pray. Zero structured hiring process for certified rowing coaches.'
  },

  // CONTROL GROUP (Software/B2B to show ICP exclusion)
  {
    id: 'c_024', name: 'Databricks', industry: 'Tech & Software', employeeCount: 5000, openRoles: 400, hiringVelocityScore: 90, currentAts: 'Greenhouse', employerBrandScore: 95, hq: 'San Francisco, CA', notes: 'Enterprise AI Data company.', painPoint: 'Need highly technical API integrations, not an ICP for Teamtailor retail pitch.'
  },
  {
...
export const getTargetingScore = (company: Company) => {
  // Teamtailor wins when Hiring Velocity is High and Employer Brand Score is Low
