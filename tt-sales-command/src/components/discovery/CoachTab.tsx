...
export function CoachTab({
  ...
  const handleGenerateEmail = async () => {
    ...
    setGeneratedEmail('');
    const repName = effectiveUser?.full_name?.split(' ')[0] || 'Teamtailor';
    try {
              ...
              <div className="space-y-2">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-[10px] text-stone-700 leading-snug">
                    <span className="font-bold">Did you diagnose the bigger problem?</span> If not, go back to D2. They're comparing your price to a simple ATS, not the full platform they need.
                  </p>
                </div>
                <div className="flex items-start gap-2">
          ...
          <div className="space-y-4">
            <div className="p-3 bg-stone-50 border border-stone-200 rounded-lg">
              ...
              <p className="text-[10px] text-stone-600 mb-2 leading-relaxed">
                External agencies charge 15-20% of first-year salary. If Teamtailor helps bring even 2 roles in-house per quarter (saving ~$30K total), the platform pays for itself instantly.
              </p>
            ...
            <div className="p-3 bg-stone-50 border border-stone-200 rounded-lg">
              ...
              <p className="text-[10px] text-stone-600 mb-2 leading-relaxed">
                Most companies pay for expensive LinkedIn Recruiter seats year-round even during hiring freezes. Teamtailor's 'Connect' builds a free talent pool that replaces this dependency.
              </p>
