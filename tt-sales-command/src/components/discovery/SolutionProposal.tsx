...
const ALIGNMENT_ITEMS: {
...
}[] = [
  {
    ...
    description: 'We\'ve mapped each of your pain points to a specific Teamtailor capability.',
  },
  {
    key: 'roi_sufficient',
    icon: BarChart3,
  ...
  },
  {
    ...
    description: 'This is the final confirmation that Teamtailor is the partner to move forward with.',
  },
];
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-3 text-sm">
                      <li className="flex items-start gap-3">
                        ...
                        <span className={`font-semibold ${isSelected ? 'text-white' : 'text-stone-900'}`}>Teamtailor Core Platform</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={16} className={`mt-0.5 shrink-0 ${isSelected ? 'text-[#0ea5e9]' : 'text-[#0ea5e9]'}`} />
 ...
 : 'bg-stone-100 text-stone-900 hover:bg-stone-200'
          ...
          <div className="p-8">
            <div className="mb-3 flex items-center gap-3">
              <h3 className="text-xl font-bold">Teamtailor Platform</h3>
              <span
