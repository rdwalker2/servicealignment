          ...
          <table className="w-full text-[13px] border-collapse">
            ...
            <tbody>
              ...
              <tr className="bg-stone-50">
                ...
                <td className="p-3 border border-stone-200 text-emerald-700">"Our HRIS ATS module just isn't cutting it for what we need."</td>
