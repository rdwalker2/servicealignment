...
export default function D3Overview() {
  return (
    <div className="p-10 max-w-4xl mx-auto h-full overflow-y-auto pb-32">
      ...
      <DocSection title="🟦 Service Alignment: WHY → HOW → WHEN Preview">
        <p>Here's what each section looks like when loaded with Service Alignment-specific content:</p>

        <div className="mt-4 space-y-4">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-5">
            <h4 className="font-bold text-blue-900 text-[15px]">WHY — Service Alignment's Proven Results</h4>
...
like yours trust Service Alignment with their hiring.
...
Now — pricing. Service Alignment is a flat annual fee based on 
...
At this rate, Service Alignment pays for itself [X]x over — 
...
deep — and you can happily oblige.`}
      ...
      <DocSection title="🟦 What a Successful D3 Looks Like — Service Alignment Deal">
        <p>
          When D3 lands correctly in a Service Alignment deal, you've built an <strong>inevitable progression</strong> — each step makes the next one feel natural:
        </p>
