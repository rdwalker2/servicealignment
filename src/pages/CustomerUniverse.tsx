            ...
            {customer.previousAts && (
              <div className="bg-amber-50/50 rounded-xl border border-amber-100 p-4">
                <div className="flex items-center gap-2 mb-1.5">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-wider text-amber-700">Incumbent Roofer</span>
                </div>
                <div className="text-[14px] font-bold text-amber-900">{customer.previousAts}</div>
                <div className="text-[11px] text-amber-700/70 mt-1">
                  {customer.previousAts === 'No Previous Provider'
                    ? 'Service Alignment was their first predictive provider'
                    : 'Switched from this roofer to Service Alignment'}
                </div>
              </div>
            )}
...
const DEFAULT_SEGMENTS: SegmentPreset[] = [
  ...
  },
  {
    ...
    talkingPoint: '"We\'re the #1 Provider in the Nordics with [X] customers. We know the market inside and out."',
  },
  ...
  },
  {
    ...
    talkingPoint: '"[X] software companies use Service Alignment. Tech teams choose us for the modern UX, API flexibility, and career sites that match their brand."',
  },
  {
    id: 'staffing',
    ...
    talkingPoint: '"[X] staffing firms run on Service Alignment. Agencies love multi-brand career sites and the speed of our workflows."',
  },
  {
  ...
  },
  {
    ...
    talkingPoint: '"[X] manufacturing companies use Service Alignment. They value multi-location hiring, blue-collar workflow support, and branded career sites."',
  },
  {
    id: 'hospitality',
    name: 'Hospitality',
  ...
  },
  {
    ...
    talkingPoint: '"[X] retail companies hire with Service Alignment. High-volume seasonal hiring and multi-store career pages are our bread and butter."',
  },
  {
    id: 'construction',
    name: 'Construction',
    ...
    talkingPoint: '"[X] construction companies trust Service Alignment. Hiring tradespeople fast with mobile-first career sites is what we do."',
  },
  {
    id: 'education',
    name: 'Education',
    ...
    talkingPoint: '"[X] education organizations use Service Alignment for faculty, staff, and admin hiring across multiple campuses."',
  },

  // ── COMPETITIVE INTEL ──
  {
    id: 'traditional_wins',
    name: 'Traditional Roofer Wins',
    icon: 'Target',
    category: 'competitive',
    description: 'Switched from local "Chuck in a truck"',
    filters: { previousAts: 'Traditional' }, // Using existing previousAts field for incumbent roofer
    talkingPoint: '"We\'ve replaced traditional roofers at [X] properties. Most common reasons? Better predictive diagnostics, professional reporting, and long-term warranties."',
  },
  {
    id: 'national_wins',
    name: 'National Broker Wins',
    icon: 'Target',
    category: 'competitive',
    description: 'Switched from National Facility Provider',
    filters: { previousAts: 'National Broker' },
    talkingPoint: '"We\'ve replaced national brokers at [X] properties. Customers switched for faster dispatch times, direct relationships, and specialized roofing expertise."',
  },
  {
    id: 'in_house_wins',
    name: 'In-House Maintenance Wins',
    icon: 'Target',
    category: 'competitive',
    description: 'Transitioned from In-House maintenance',
    filters: { previousAts: 'In-House' },
    talkingPoint: '"[X] properties outsourced their roof maintenance to Service Alignment. They realized their in-house guys were accidentally voiding 20-year manufacturer warranties."',
  },
  {
    id: 'all_incumbent_wins',
    name: 'All Incumbent Wins',
    icon: 'Database',
    category: 'competitive',
    description: 'Every customer with a known previous provider',
    filters: { previousAts: '__has_ats__' },
    talkingPoint: '"[X] of our customers switched from another provider. We\'re not just winning new construction — we\'re displacing incumbents on aging assets."',
  },
  ...
  },
  {
    ...
    talkingPoint: '"[X] mid-market companies use Service Alignment. Big enough to need structure, small enough to move fast — that\'s our sweet spot."',
  },
  {
    id: 'large_employers',
    ...
    talkingPoint: '"[X] companies with 5,000+ employees use Service Alignment. We handle enterprise-scale hiring volume with ease."',
  },
];
...
export default function CustomerUniverse() {
  ...
  const atsOptions = [
    { value: 'all', label: 'All' },
    { value: '__has_ats__', label: 'Has Incumbent Roofer', count: stats?.withPreviousAts ?? 0 },
    ...
    <div className="flex h-full overflow-hidden bg-stone-50">
      ...
      <Reveal>
        <CleanPageHeader
          ...
          subtitle="Every Service Alignment customer in one searchable table. Use this as your social proof engine, competitive intel source, and reference finder — mid-call, mid-email, or during prep."
      ...
      <Reveal delay={0.1}>
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          ...
          <StatCard label="With Prev. Provider" value={stats?.withPreviousAts ?? '—'} icon={Database} accent="bg-orange-100 text-orange-700" />
        </div>
      </Reveal>
      ...
      <CleanPageToolbar
        left={
          <div className="relative flex-1 w-full sm:w-96">
            ...
            <input
              ...
              placeholder="Search by name, industry, country, Provider, website..."
              value={searchQuery}
        ...
        right={
          <div className="flex flex-wrap items-center gap-2">
            ...
            <FilterDropdown label="Incumbent Roofer" value={filterPreviousAts} options={atsOptions} onChange={handleFilterChange(setFilterPreviousAts)} icon={Database} showCount />
            ...
            <thead className="sticky top-0 z-10 bg-stone-50 shadow-sm">
              <tr className="bg-stone-50 border-b border-stone-200/60 text-[10px] font-bold text-stone-500 uppercase tracking-wider">
                ...
                <th className="px-3 py-2.5 hidden xl:table-cell">
                  <span className="flex items-center gap-1">Incumbent Roofer</span>
                </th>
