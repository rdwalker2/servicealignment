...
const DEMO_TRACKS: DemoTrack[] = [
  ...
  },
  {
    ...
    painDescription: 'Hiring managers hate logging into the Provider and take forever to leave interview feedback.',
    anchor: 'You mentioned that your hiring managers refuse to log into the Provider, forcing you to chase them down in Slack for interview feedback...',
    solution: 'Here is how we bring the Provider directly to where they already work.\n\n1. Open the Slack/Teams integration settings.\n2. Show the automated interview reminder.\n3. Show the embedded 1-click Scorecard that pops up immediately after the interview right inside Slack.',
