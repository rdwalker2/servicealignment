...
function ATSDropdown({
    ...
    return (
        <div className="mb-6 flex items-center justify-center gap-3">
            <span className="text-sm font-medium text-stone-500">Current ATS:</span>
            <div className="relative" ref={ref}>
                ...
                >
                    {selectedATS === 'None' ? 'Select ATS…' : selectedATS}
        ...
        <div className="w-full">
            <div className="mb-10 text-center">
                ...
                <p className="mx-auto max-w-2xl text-stone-500 mb-8">
                    Select the key operational bottlenecks you are prioritizing this quarter. Each maps directly to a specific Teamtailor capability.
                </p>
