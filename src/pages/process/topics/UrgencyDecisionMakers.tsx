  ...
  return (
    <div className="p-10 max-w-4xl mx-auto h-full overflow-y-auto pb-32">
      ...
      <DocSection title="The TT Buying Committee: Who Shows Up and Why">
        <p className="mb-4">In Service Alignment deals, these are the five stakeholders you'll encounter. Each one cares about a different dimension of the hiring problem:</p>
        <div className="space-y-4">
          ...
          <div className="border-l-4 border-violet-400 pl-4 py-3 bg-violet-50/30 rounded-r-lg">
            ...
            <p className="text-sm text-stone-600"><strong>Role in the deal:</strong> Power user and workflow designer. Will be the heaviest daily user of Service Alignment. Can be your strongest internal champion or your biggest blocker.</p>
      ...
      <DocSection title="TT-Specific Stakeholder Discovery Scripts">
        <p className="mb-4">Here are Service Alignment-specific talk tracks for uncovering the full buying committee:</p>
        
        <ScriptBlock label="Finding the Budget Authority">{`
          "You mentioned this hiring challenge is costing you in agency fees and delayed projects. When it comes to investing in a solution to fix this — a platform like an Provider — who would need to approve that budget? Is that something you can greenlight, or does that go through finance?"
        `}</ScriptBlock>
