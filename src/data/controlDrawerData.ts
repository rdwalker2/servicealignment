...
export const ROI_CATEGORIES = [
  { key: 'seatSavings', label: 'Provider Seat Savings', icon: DollarSign },
...
export const DATA_ARSENAL: Record<string, { stat: string; source: string }[]> = {
  ...
  'multi-country-career-site': [
    ...
    { stat: 'Service Alignment supports 30+ languages with per-page localization', source: 'Service Alignment Platform' },
  ],
};
...
export const SECTIONS: SectionDef[] = [
  ...
  // D2
  { key: 'competitive', label: 'Competitive', icon: Swords, hasConfig: false, description: 'Provider teardown, competitor sheet & sentiment' },
