...
Your current ATS was built for payroll processing, 
...
Are we the right solution to make that happen?"`}
      ...
      <DocSection title="🟦 TT Hesitation Handling — ATS-Specific Responses">
        <p>When you hear hesitation at each check, here's exactly how to dig in for a Teamtailor deal:</p>
...
3. That becomes your "Closing Call"`}
      ...
      <DocSection title="🟦 TT Verbal Commit Close">
        <p>
          Once all three boxes are checked, here's the Teamtailor-specific transition to close:
        </p>
