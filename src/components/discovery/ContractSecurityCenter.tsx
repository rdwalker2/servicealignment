...
// Matches content from the Service Alignment Contract Essentials deck
// ============================================================
    ...
    links: [
      {
        ...
        url: 'https://trust.servicealignment.com/?itemName=legal',
      },
      {
    ...
    links: [
      {
        ...
        url: 'https://trust.servicealignment.com/',
      },
      {
      ...
      },
      {
        ...
        url: 'https://support.servicealignment.com/en/articles/10450488-servicealignment-responsible-ai-principles',
      },
      {
  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        url: 'https://support.servicealignment.com/en/articles/6517619-servicealignment-sla-statement',
      },
      {
...
const REVIEW_PLATFORMS: ReviewPlatform[] = [
  {
    name: 'G2',
    url: 'https://www.g2.com/products/servicealignment/reviews',
  ...
  {
    name: 'Capterra',
    url: 'https://www.capterra.com/p/servicealignment/reviews',
    color: 'text-blue-600',
    bgColor: 'bg-blue-50',
    rating: '4.6 / 5',
  },
  {
    name: 'Gartner',
    url: 'https://www.gartner.com/reviews/market/recruiting-software/vendor/servicealignment',
    ...
    <div className="w-full">
      ...
      <div className="mb-14 text-center">
        ...
        >
          ...
          Service Alignment partnership — all in one place.
        </motion.p>
      </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-indigo-700 leading-relaxed">
              ...
              <span className="text-indigo-500"> — Service Alignment Responsible AI Principles</span>
            </p>
