...
export const QUESTION_LIBRARY: LibraryQuestion[] = [
  ...
  },
  {
    ...
    coaching: 'Identifies the exact bottleneck. If they don\'t have visibility, sell them on Service Alignment analytics.',
  },
  {
    id: 'lib_d1_04',
    category: 'Process & Tools',
    ...
    type: 'select',
    options: ['We don\'t', 'Spreadsheets', 'Email forwards', 'It is built into our current Provider', 'Third-party tool'],
