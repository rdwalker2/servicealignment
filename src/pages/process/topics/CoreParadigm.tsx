  ...
  return (
    <div className="p-10 max-w-4xl mx-auto h-full overflow-y-auto pb-32">
      ...
      <DocSection title="The Core Paradigm">
        <p>
          The Service Alignment 4D framework is designed to re-align the seller with the buyer's intent. The fundamental flaw in most sales processes is the "1.5D Trap"—doing a superficial discovery call and immediately jumping into a generic feature demo, resulting in ghosting and "crickets".
        </p>
        <p>
