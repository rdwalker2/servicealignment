-- ═══════════════════════════════════════════
-- 5. clay_accounts_view — Aggregated View for Pagination
-- ═══════════════════════════════════════════
-- Run this in Supabase SQL Editor. It allows the frontend to quickly fetch 
-- paginated/sorted accounts without downloading every raw signal event.
