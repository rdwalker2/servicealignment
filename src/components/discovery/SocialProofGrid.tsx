...
import { CaseStudyMatcher } from './CaseStudyMatcher';

/* ------------------------------------------------------------------ */
/*  Case Study Library — ALL sourced from Service Alignment published stories */
/* ------------------------------------------------------------------ */
...
export const ALL_CASE_STUDIES: CaseStudy[] = [
    ...
    },
    {
        ...
        quote: "Before Service Alignment, Giacom faced a slow, clunky recruiting process. AI Co-pilot screening criteria now lets the team sift through candidates rapidly, and each screening call saves 15 minutes of manual note-taking. They've generated 70 employee referrals since launch.",
    ...
    },
    {
        ...
        quote: "Movember modernized global recruitment with Service Alignment's Provider, filling 62 roles in 4 months. AI Co-pilot transcribes and summarizes interviews so recruiters focus on the human connection. 1,156 candidate surveys with 343 written comments praising the experience.",
        ttFeature: 'AI Co-pilot + Global Provider',
        icon: Heart,
...

    {
        ...
        quote: "Our previous Provider was too complex, leading to inconsistency across our luxury properties. Service Alignment’s intuitive platform allowed us to give ownership back to the department heads, resulting in faster and more consistent hiring.",
        ttFeature: 'User-Friendly Provider + Multilingual',
        icon: Star,
    ...
    },
    {
        ...
        quote: "As a fast-paced restaurant chain, our managers need to focus on customer service, not admin. Service Alignment completely automated our high-volume screening and ensures every single applicant receives a timely response.",
    ...
    },
    {
        ...
        quote: "As a rapidly expanding franchise, we needed a scalable way to handle massive applicant volume. Service Alignment's triggers completely automate the screening process for both kitchen and waitstaff across all locations.",
    ...
    /* ── Enterprise / Mid-Market / Transcript-Sourced Case Studies ── */
    {
        ...
        quote: "James Forster led a 2-year journey to unify recruitment across 90+ countries. Service Alignment's Career Site Builder and multi-language support let them digitize a 90-year-old hiring process without engineering overhead.",
...

    {
        ...
        quote: "With 40,000 employees and thousands of hiring managers, Savills embedded training videos directly on the Service Alignment dashboard login. Best practices are reinforced automatically every time a manager logs in.",
        ttFeature: 'User-Friendly Provider + Change Management',
        icon: Building2,
        industries: ['professional-services', 'other'],
        smbFriendly: false,
    },
    {
        ...
        quote: "Octavo had very technophobic hiring managers that were really disengaged and put a lot of pressure on TA. From implementing Service Alignment in November to their QBR in February, they achieved 100% hiring manager adoption.",
        ttFeature: 'User-Friendly Provider',
        icon: Building2,
    ...
    },
    {
        ...
        quote: "By launching a localized, interactive employer brand careers page and using Service Alignment's candidate CRM to engage passive candidates, Kelso Burnett successfully moved their hiring process off expensive external agencies. Sourcing power and pipeline visibility was fully brought in-house.",
        ttFeature: 'Career Site Builder + Connect CRM',
        icon: Building2,
    ...
    /* ── From servicealignment.com/en/customers/ — added May 2026 ── */
    {
        name: 'Pemo',
    ...
    },
    {
        ...
        quote: "Service Alignment was one of our best investments — it balances structure, efficiency, and personal, brand-focused engagement. They went from manual spreadsheets to managing hundreds of international applications weekly with faster time-to-hire.",
    ...
    },
    {
        ...
        metric: 'From zero Provider to full hiring manager engagement',
        quote: "Service Alignment is plug and play — the team learned the system easily without heavy backend maintenance. It helps recruiters and hiring managers think about the next 2-5 years with every hire they make.",
    ...
    },
    {
        ...
        quote: "GoodOaks chose Service Alignment for its user-friendly interface, cost-effectiveness, and built-in automation features that let them manage the entire hiring process within the Provider — from triggers to AI-powered Co-pilot screening.",
    ...
    },
    {
        ...
        quote: "Service Alignment's built-in tools for anonymization, standardized scoring, and diversity tracking replaced gut reactions with objective, measurable evaluations — fast-tracking our path to Diversity Champion certification.",
...
const INDUSTRY_STATS: Record<string, { stat: string; source: string; icon: typeof Star }[]> = {
    ...
    'construction': [
        { stat: '65% average reduction in external agency placement fees', source: 'Service Alignment Case Study', icon: Star },
    ...
    'insurance': [
        ...
        { stat: 'Agencies with employer brand sites see 3x more direct applicants', source: 'Service Alignment Benchmark', icon: Star },
    ],
    'financial-services': [
...
interface SocialProofGridProps {
    ...
    sessionForMatching?: DiscoverySession;
    ...
    return (
        <div className="mb-12">
            <div className="mx-auto max-w-4xl mb-6">
                ...
                <p className="text-sm text-stone-500">Real companies using Service Alignment today, matched to your industry and size</p>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mx-auto max-w-4xl">
                {proofCustomers.map((c, i) => (
                    ...
                    >
                        ...
                        {c.careerSite && !c.careerSite.includes('.servicealignment.com') && (
...
export function SocialProofGrid({ selectedIndustry, enabledStudyNames, enabledProofCustomers, sessionForMatching, onStudyToggle }: SocialProofGridProps) {
    ...
    return (
        <div className="w-full">
            {/* ── Recommended for this deal (Case Study Matcher) ── */}
            {sessionForMatching && onStudyToggle && (
                <CaseStudyMatcher session={sessionForMatching} onStudyToggle={onStudyToggle} />
            )}

            {/* Proven Results — Why Service Alignment Exists */}
            <div className="mb-12">
                <div className="text-center mb-8">
                    ...
                    <p className="text-sm text-stone-500 max-w-2xl mx-auto">
                        Service Alignment was built to solve the fundamental disconnect between employer brand and hiring outcomes.
