...
✅ Doctor: "Here's how these calls go — I'll start by asking you some questions to understand what's going on. The goal is that you come out of this with a plan of action, even if that plan doesn't include us. Sound good?"`}
      ...
      <DocSection title="The TT Doctor's Office Script">
        <p>Here's the exact Service Alignment version of the Doctor's Office opening vs. the Date opening:</p>

        <ScriptBlock label="❌ Date Opening — Don't Do This">
{"Hey! Thanks so much for taking the time. Tell me a little about your company! How many employees do you have? That's great! So we're Service Alignment and we're an all-in-one recruiting platform that helps companies attract and hire..."}
        </ScriptBlock>
...
{"Here's how these calls typically go — I'll ask you about your current hiring process, where candidates are dropping off, what tools you're using today, and what outcomes you're trying to achieve. By the end, we'll both know if it makes sense to keep talking. Sound fair?"}
      ...
      <DocSection title="The TT Diagnostic Question Flow">
        <p>Once you've set the Doctor's Office frame, use this 6-step diagnostic sequence to systematically uncover pain:</p>
        ...
        <div className="space-y-3 mt-4">
          <div className="flex gap-3 items-start">
            ...
            <div>
              <p className="font-bold text-stone-800">Initiative: "What strategic goal or problem brought you to this call?"</p>
              <p className="text-[13px] text-stone-500 mt-1">Opens the door to: hiring bottlenecks, screening speed, career site quality, HM responsiveness.</p>
            </div>
          </div>
          <div className="flex gap-3 items-start">
            ...
            <div>
              <p className="font-bold text-stone-800">Priority: "On a scale of 1 to 10, how critical is fixing this for your team right now?"</p>
              <p className="text-[13px] text-stone-500 mt-1">Reveals: urgency level. If it's a 4, you must elevate the pain or disqualify.</p>
            </div>
          </div>
          <div className="flex gap-3 items-start">
            ...
            <div>
              <p className="font-bold text-stone-800">Process: "Walk me through what happens from req-open to offer-accepted."</p>
              <p className="text-[13px] text-stone-500 mt-1">Pinpoints: process gaps, manual steps, where they lose time and candidates.</p>
            </div>
          </div>
          <div className="flex gap-3 items-start">
            ...
            <div>
              <p className="font-bold text-stone-800">Stakeholders: "Who else is involved in solving this problem?"</p>
              <p className="text-[13px] text-stone-500 mt-1">Uncovers: the real decision makers, budget approvers, and internal dynamics.</p>
            </div>
          </div>
          <div className="flex gap-3 items-start">
            ...
            <div>
              <p className="font-bold text-stone-800">Infrastructure: "What tools are you using today, and what have you tried to fix this?"</p>
              <p className="text-[13px] text-stone-500 mt-1">Exposes: HRIS Provider limitations, agency dependency, and failed past solutions.</p>
            </div>
          </div>
          <div className="flex gap-3 items-start">
            <span className="w-8 h-8 rounded-full bg-[#FF2A7F]/10 flex items-center justify-center text-[#FF2A7F] text-sm font-black shrink-0">6</span>
            <div>
              <p className="font-bold text-stone-800">Inaction Cost: "What happens if this trend continues?"</p>
              <p className="text-[13px] text-stone-500 mt-1">The kill shot: forces them to admit the cost of doing nothing, anchoring the value of your solution.</p>
            </div>
          </div>
        </div>

        <Callout type="rule" title="Never Skip Question 6">
          Questions 1-5 build the picture. Question 6 locks in the gap and urgency. If inaction doesn't cost them anything, you don't have a deal anyway. If it does, you've just earned the right to prescribe a solution.
        </Callout>
      </DocSection>
    </div>
  );
