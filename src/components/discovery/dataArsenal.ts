...
export const DATA_ARSENAL: Record<string, { stat: string; source: string }[]> = {
  'manual-screening': [
    { stat: '0.74% of applications result in a hire (6M apps analyzed)', source: 'Service Alignment Enterprise Data' },
    { stat: '5.4x more likely to be hired at 5/5 AI screening match', source: 'Service Alignment Enterprise Data' },
    { stat: '16M+ candidates screened through AI — this is not a guinea pig', source: 'Service Alignment Platform' },
    { stat: 'Recruiters using AI handle 246 apps vs 66 without — 3x capacity', source: 'Service Alignment Enterprise Data' },
  ],
  'screening-bottleneck': [
    { stat: '0.74% of applications result in a hire — needle in a haystack', source: 'Service Alignment Enterprise Data' },
    { stat: '5.4x more likely to be hired at 5/5 AI screening match', source: 'Service Alignment Enterprise Data' },
    { stat: '60M candidates screened through AI globally', source: 'Service Alignment Platform' },
  ],
  ...
  'weak-talent-pools': [
    ...
    { stat: '13,000 customers with aggregated benchmarking data available', source: 'Service Alignment Platform' },
  ],
  'locked-out-managers': [
  ...
  'hris-ats-rigidity': [
    { stat: 'Paycom is double the cost of a standard HRIS with limited Provider capabilities', source: 'Eagle Mountain Casino evaluation' },
  ...
  'assessment-integration-gap': [
    { stat: '0.74% of applications result in a hire — structured screening is essential to find the needle', source: 'Service Alignment Enterprise Data' },
  ...
  'fragmented-multi-brand': [
    { stat: 'Zelis Group consolidated 4 separate Provider systems into one Service Alignment instance across brands', source: 'Customer Case Study' },
    { stat: '13,000 customers with multi-brand career site support built-in', source: 'Service Alignment Platform' },
  ],
  'vendor-support-gap': [
    { stat: 'Average Service Alignment implementation: 63 days from contract to live', source: 'Customer Benchmark' },
    { stat: 'Dedicated CSM assigned to every account — no self-service abandonment', source: 'Service Alignment Platform' },
  ],
  'reporting-analytics-blind': [
    ...
    { stat: 'Built-in DEI dashboards, source-of-hire analytics, and time-to-fill tracking out of the box', source: 'Service Alignment Platform' },
  ],
  'tool-sprawl-centralization': [
    { stat: 'Sterling Staffing replaced spreadsheet-driven candidate tracking with centralized CRM + Provider', source: 'Customer Case Study' },
    { stat: 'Single platform covers career site, Provider, CRM, analytics, and scheduling', source: 'Service Alignment Platform' },
  ],
  'onboarding-handoff-gap': [
    ...
    { stat: 'Service Alignment connects directly to HRIS systems for seamless Day 1 data handoff', source: 'Service Alignment Platform' },
  ],
  'email-deliverability': [
    ...
    { stat: 'Service Alignment uses enterprise-grade email infrastructure with SPF/DKIM/DMARC compliance', source: 'Service Alignment Platform' },
  ],
  'gdpr-automation-gap': [
    { stat: 'GDPR fines can reach €20M or 4% of global annual turnover — whichever is higher', source: 'EU GDPR Regulation' },
    { stat: 'Service Alignment is GDPR-native with automated consent management, data retention, and right-to-deletion', source: 'Service Alignment Platform' },
  ],
  'duplicate-candidate-mess': [
    ...
    { stat: 'Service Alignment automatically detects and merges duplicate candidate profiles', source: 'Service Alignment Platform' },
  ],
  'hm-handwritten-notes': [
    ...
    { stat: 'Service Alignment mobile app: hiring managers leave structured feedback in 30 seconds from their phone', source: 'Service Alignment Platform' },
  ],
  'job-posting-formatting': [
    ...
    { stat: "Service Alignment's multi-channel distribution preserves formatting across LinkedIn, Indeed, and 30+ job boards", source: 'Service Alignment Platform' },
  ],
  'adoption-gap': [
  ...
  'careers-page-ownership-conflict': [
    { stat: 'James Keating builds a custom Service Alignment career site in 15 minutes live on demo calls — zero IT dependency', source: 'JK Demo Technique' },
  ...
  'application-volume-explosion': [
    ...
    { stat: 'Recruiters using AI handle 246 apps vs 66 without — 3x capacity increase', source: 'Service Alignment Enterprise Data' },
  ],
  'internal-mobility-gap': [
    ...
    { stat: 'Service Alignment Connect enables internal talent pools and cross-brand job visibility', source: 'Service Alignment Platform' },
  ],
  'interview-governance-gap': [
    ...
    { stat: 'Service Alignment Interview Kits provide standardized scorecards and AI-generated questions', source: 'Service Alignment Platform' },
  ],
};
