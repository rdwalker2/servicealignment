...
async function main() {
  ...
  // Use PapaParse to correctly handle multiline cells!
  ...
  // We will delete all db sessions that are NOT in the CSV (by Account Name & Opportunity Name)
