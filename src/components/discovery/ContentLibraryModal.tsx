        ...
        <table className="w-full text-[9px] border-collapse">
          <thead>
            <tr>
              ...
              <th className="text-left py-1 px-1.5 text-indigo-600 border-b border-stone-200 font-semibold">Service Alignment</th>
          ...
          <tbody>
            {content.rows.map((row: any, i: number) => (
              <tr key={i}>
                ...
                <td className="py-1 px-1.5 text-stone-500 border-b border-stone-100">{(row.servicealignment || '').slice(0, 80)}</td>
      ...
      <div className="rounded-lg bg-stone-50 p-3 mt-1">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className="rounded-lg bg-emerald-50 border border-emerald-100 p-2.5">
            <p className="text-[8px] font-bold text-emerald-600 uppercase mb-1">With Service Alignment</p>
