  ...
  return (
    <div className="p-10 max-w-4xl mx-auto h-full overflow-y-auto pb-32">
      ...
      <DocSection title="The TT Gap Test Flow">
        <p className="mb-4">Here's what each Gap Test objective sounds like in a Teamtailor deal. Use these as your mental model going into D2:</p>
        <div className="space-y-4">
          <div className="border-l-4 border-blue-400 pl-4 py-3 bg-blue-50/30 rounded-r-lg">
            <h4 className="font-bold text-stone-900 mb-1">1. Other Vendors</h4>
            <p className="text-sm text-stone-700 italic">{`"What ATS are you using today? Greenhouse? ADP's recruiting module? Spreadsheets and email? Help me understand what's working and what's not."`}</p>
          </div>
          <div className="border-l-4 border-violet-400 pl-4 py-3 bg-violet-50/30 rounded-r-lg">
            ...
            <p className="text-sm text-stone-700 italic">{`"The real issue isn't that you need a new ATS — it's that your current process can't scale. You're using a system built for compliance, not candidate engagement. That's why time-to-hire keeps climbing even though your team is working harder."`}</p>
          </div>
          <div className="border-l-4 border-amber-400 pl-4 py-3 bg-amber-50/30 rounded-r-lg">
          ...
          <div className="border-l-4 border-emerald-400 pl-4 py-3 bg-emerald-50/30 rounded-r-lg">
            ...
            <p className="text-sm text-stone-700 italic">{`"What are you spending today on job boards, agencies, and recruiter time? Most companies I talk to are shocked when they actually add it up — it's usually $300K-500K+ per year on a process that's not working. Teamtailor is a fraction of that."`}</p>
          </div>
        </div>
      </DocSection>
...
But typically when we see that, the real issue is that hiring managers are completely disconnected from the ATS, meaning your talent team is doing double the admin work (Bigger Problem). 
...
"Our hiring managers never log into the ATS — they just email the recruiter and it creates a bottleneck."
