...
const USERS: { email: string; role: AppRole; profileId: string }[] = [
  { email: 'ryandeniswalker@gmail.com', role: 'admin', profileId: 'admin-ryan' },
  { email: 'jack.luther@servicealignment.com', role: 'rep', profileId: 'rep-jl' },
  { email: 'moe.aqel@servicealignment.com', role: 'rep', profileId: 'rep-ma' },
  { email: 'tyler.hanson@servicealignment.com', role: 'rep', profileId: 'rep-th' },
  { email: 'katy.shelman@servicealignment.com', role: 'rep', profileId: 'rep-ks' },
  // ── Exec stakeholders ──
  { email: 'brian.mcgarry@servicealignment.com', role: 'exec', profileId: 'exec-bm' },
  { email: 'daniel.mathisen@servicealignment.com', role: 'exec', profileId: 'exec-dm' },
  { email: 'gordon.french@servicealignment.com', role: 'exec', profileId: 'exec-gf' },
  { email: 'jesper.astrom@servicealignment.com', role: 'exec', profileId: 'exec-ja' },
];
