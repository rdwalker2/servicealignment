...
export const TARGET_ACCOUNTS: TargetAccount[] = [
  ...
  },
  {
    ...
    reasonToTarget: 'Aggressive hiring amid cyber threats. Workday Provider severely limits the engaging career site customization essential for mid-market branding.',
  ...
  // Healthcare & Clinics
  {
    ...
    reasonToTarget: 'Scaling clinic software post-acquisition. Relying on Workday Provider with known rigidity hurting high-volume clinical candidate engagement.',
  ...
  },
  {
    ...
    reasonToTarget: 'Scaling post-Amazon buyout. Workday Provider limits dynamic employer stories vital for acquiring highly competitive healthcare talent.',
  ...
  // Retail & Hospitality
  {
    ...
    reasonToTarget: 'Fast-casual chain scaling 200+ locations. Workday Provider creates incredibly rigid, corporate experiences failing to showcase their vibrant culture to Gen Z.',
  ...
  },
  {
    ...
    reasonToTarget: 'Direct-to-patient healthcare scaling rapidly. Workday Provider creates excessive friction for tech and medical talent used to modern, seamless digital experiences.',
  ...
  },
  {
    ...
    reasonToTarget: 'E-commerce darling scaling manufacturing & corporate. Workday Provider is too heavy and bureaucratic, killing conversion rates for agile e-com talent.',
