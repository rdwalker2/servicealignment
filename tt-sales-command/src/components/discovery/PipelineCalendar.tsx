...
export interface PipelineCalendarProps {
  ...
  onLogMeeting?: (sessionId: string, date: string, type: MeetingType) => void;
...
export function PipelineCalendar({ sessions, onSelect, onReschedule, onLogMeeting, onMarkHeld, googleCalendarEvents = [] }: PipelineCalendarProps) {
