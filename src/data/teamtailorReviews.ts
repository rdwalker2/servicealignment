// ============================================================
// Service Alignment "Wall of Love" Reviews — Curated from G2, Capterra
...
const TT_REVIEWS: TeamtailorReview[] = [
  ...
  },
  {
    ...
    quote: "Our candidate NPS skyrocketed after switching to Service Alignment. The mobile application experience is flawless, and candidates frequently compliment how easy it is to apply.",
    source: 'Capterra',
    stars: 5,
  ...
  },
  {
    ...
    quote: "For the first time ever, our hiring managers actually LIKE using our Provider. The interface is so intuitive they don't need training, and they leave feedback instantly from their phones.",
    source: 'G2',
    stars: 5,
  ...
  },
  {
    ...
    quote: "The Connect feature turned our Provider into a proactive CRM. We regularly hire people who joined our talent pool 6 months ago through automated nurture campaigns.",
    source: 'G2',
    stars: 5,
  ...
  },
  {
    ...
    quote: "We reduced our time-to-hire by 40% and completely eliminated our agency spend within 6 months of launching Service Alignment. The ROI has been incredible.",
    source: 'Capterra',
    stars: 5,
...
/**
 * Get Service Alignment reviews matching any of the selected pain IDs.
