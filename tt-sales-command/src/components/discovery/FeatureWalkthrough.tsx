...
export const DEMO_AREAS: DemoArea[] = [
  ...
  { 
    id: 'capture', 
    title: 'Capture (ATS & AI Automation)', 
    icon: Shield, 
...
const FEATURES: Record<string, FeatureData> = {
  ...
  'locked-out-managers': { title: 'Consumer-Grade Mobile App', product: 'Mobile App + Chat', without: 'Managers refuse the ATS — recruiters do admin FOR them', withTT: 'Full pipeline management from any device, in under 30 seconds', proof: 'Actavo — 90% hiring manager adoption on mobile' },
  ...
  'high-cost-per-hire': { title: 'All-in-One Platform', product: 'Platform', without: 'Paying for 5+ separate recruiting tools — hidden TCO', withTT: 'One platform replaces your entire recruiting tech stack', proof: 'Companies save $15K+/year consolidating to Teamtailor' },
    ...
    <div>
      ...
      <div className="mb-4 text-center">
        ...
        <p className="mx-auto max-w-2xl text-sm leading-relaxed text-zinc-500">
          Based on the challenges you've identified, here's exactly how Teamtailor handles the complexity —
      ...
      >
        ...
        <div>
          <p className="text-xs font-bold uppercase tracking-wider text-zinc-500">The Teamtailor Approach</p>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="border-t border-zinc-100 pt-3 mt-3 flex items-center justify-between gap-3">
                        ...
                        <a 
                          href={`https://support.teamtailor.com/en/?q=${encodeURIComponent(feature.product)}`}
                          target="_blank"
