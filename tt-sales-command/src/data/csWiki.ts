...
export const csWikiData: WikiFeature[] = [
    ...
    "prospectQA": [
      {
        ...
        "a": "You'll have access to our Activation Webinar series (3 sessions covering ATS setup, jobs & automation, and career site), plus our full help center and live support chat. You can also book optional 1:1 sessions with our Digital team for hands-on guidance."
      },
      {
  ...
  },
  {
    ...
    "doNotSay": [
      "Don't promise specific CSM response time SLAs — Teamtailor explicitly states 'we don't have any SLA' for CSM response times",
  ...
  },
  {
    ...
    "subtitle": "3-session webinar series covering ATS setup, automation, and career site",
    "category": "training",
    "status": "verified",
    ...
    "prospectQA": [
      {
        ...
        "a": "Yes — every customer gets access to our 3-part Activation Webinar series covering ATS profile setup, jobs & automation, and career site design. These run in both EU and NA time zones, and recorded versions are always available."
      }
    ],
    "tags": [
      "training",
  ...
  },
  {
    ...
    "status": "verified",
    "whatItDoes": "Free self-service data import for customers migrating candidate data from legacy ATS systems. Supports CSV upload with standard field mapping.",
    "howItWorks": "1. Customer exports data from legacy system (CSV format).\n2. Map fields to Teamtailor's schema (name, email, phone, job, stage, etc.).\n3. Upload via Teamtailor's import tool in Settings.\n4. System processes and creates candidate records.\n5. Verify data integrity post-import.",
    "doNotSay": [
    ...
    "implementationNotes": "Standard import is FREE and self-service. KEY GOTCHA: Scorecards and messages from legacy ATS systems are converted to plain text notes — they do NOT maintain their structured format. Resume attachments may or may not transfer depending on how the legacy system exports them. Import tool is in Settings > Import.",
    "prospectQA": [
      {
      ...
      },
      {
        ...
        "a": "Candidate records, contact info, and application history will transfer. However, structured data like scorecards and internal messages from your current system will be converted to text notes in Teamtailor — they won't maintain their original format."
      }
    ],
    "tags": [
      "data migration",
  ...
  },
  {
    ...
    "category": "data-migration",
    "status": "verified",
    "whatItDoes": "Managed data migration service handled by Teamtailor's imports team. Supports complex field mapping, attachments, and large volumes. Runs in 6-week cycles.",
    "howItWorks": "1. Customer contacts imports@teamtailor.com to initiate.\n2. Teamtailor team reviews data structure and creates custom mapping.\n3. Test import run with sample data.\n4. Full import executed in 6-week cycle.\n5. Post-import verification and cleanup.\n\nPricing: $1,000 flat fee + $0.03 per candidate record.",
    "doNotSay": [
    ...
    "implementationNotes": "Contact: imports@teamtailor.com. Pricing: $1,000 flat + $0.03/candidate. Timeline: 6-week cycles. This is a ONE-TIME SERVICE FEE — it does NOT count toward recurring deal value. Calculate total cost for customer: e.g., 50,000 candidates = $1,000 + $1,500 = $2,500 total.",
    "prospectQA": [
      {
  ...
  },
  {
    ...
    "category": "pricing-negotiation",
    "status": "verified",
    "whatItDoes": "Governs when and how AEs can offer free months of Teamtailor service as a closing incentive. Includes approval thresholds and how free months affect contract start dates.",
  ...
  },
  {
    ...
    "prospectQA": [
      ...
      },
      {
        ...
        "a": "We have 24/7 monitoring with automated escalation. You can check our real-time status at status.teamtailor.com. For contractual uptime guarantees, we offer an SLA add-on that provides 99.9%+ guaranteed uptime."
      }
    ],
    "tags": [
      "architecture",
    ...
    "prospectQA": [
      {
        ...
        "a": "Absolutely — Teamtailor has 30+ add-on features you can activate at any time. Some are self-service toggles you can enable instantly, and others we activate on the backend. Your CSM can walk you through what's available as your needs evolve."
      },
      {
  ...
  },
  {
    ...
    "subtitle": "Step-by-step guide to enabling and configuring the Onboarding feature in Teamtailor",
    "category": "implementation",
    "status": "verified",
    "whatItDoes": "The Onboarding feature in Teamtailor enables post-hire workflows — document collection, task assignments, and new hire onboarding sequences. This is a paid add-on feature.",
    ...
    "prospectQA": [
      {
        "q": "Can Teamtailor handle new hire onboarding?",
  ...
  },
  {
    ...
    "doNotSay": [
      "Don't say Teamtailor has SLA 'by default' — it's a paid add-on",
  ...
  },
  {
    ...
    "subtitle": "5-step initial configuration checklist for new Teamtailor accounts",
    "category": "implementation",
    "status": "verified",
    "whatItDoes": "Essential first steps that every new Teamtailor customer should complete during initial setup. Referenced in support documentation and used by both Digital and CSM-guided customers.",
  ...
  },
  {
    ...
    "subtitle": "Technical teams can build their own import pipeline using the Teamtailor API",
    "category": "data-migration",
    "status": "verified",
    "whatItDoes": "For technically capable prospects, Teamtailor's REST API allows building custom import pipelines. This is the DIY option for data migration — no cost, full control.",
    "howItWorks": "1. Generate API key in Settings > Integrations > API.\n2. Use the Candidates endpoint to create/update records.\n3. Batch imports possible with rate limit awareness.\n4. Can include: candidate data, resume URLs, custom field values, tags.\n5. Full API documentation at docs.teamtailor.com.",
    "doNotSay": [
  ...
  },
  {
    ...
    "category": "implementation",
    "status": "verified",
    "whatItDoes": "Completely isolated hosting environment where the customer's data and application instance run on dedicated infrastructure, separate from all other Teamtailor customers.",
    "howItWorks": "1. Customer's entire Teamtailor instance runs on dedicated servers.\n2. Complete data isolation from other tenants.\n3. Separate database, application server, and storage.\n4. Same feature set as multi-tenant — no feature limitations.\n5. Managed by Teamtailor's infrastructure team.",
    "doNotSay": [
  ...
  },
  {
    ...
    "category": "implementation",
    "status": "verified",
    "whatItDoes": "SQL-based data connector for Power BI, Tableau, and other BI tools. Allows customers to build custom dashboards from Teamtailor data.",
  ...
  },
  {
    ...
    "category": "implementation",
    "status": "verified",
    "whatItDoes": "Teamtailor's AI assistant with 8 features: Resume Summary, Draft Reject Email, Video Meeting Summary, Answer Interview Kit Qs, Draft Job Description, Suggest Skills & Traits, Suggest Interview Kit Qs, Suggest Existing Candidates.",
    ...
    "prospectQA": [
      ...
      },
      {
        ...
        "a": "The video meeting AI features work with Teamtailor's built-in video tool. For Zoom or Teams calls, you'd use those platforms' own AI features."
      },
      {
