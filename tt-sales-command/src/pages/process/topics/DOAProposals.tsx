...
export default function DOAProposals() {
  return (
    <div className="p-10 max-w-4xl mx-auto h-full overflow-y-auto pb-32">
      ...
      <DocSection title="🟦 Teamtailor DOA Examples — The Five Fatalities In Action">
        <p>Here's what each fatality looks like in a real Teamtailor deal — and exactly how to respond:</p>
        ...
        <div className="space-y-5 mt-4">
          <div className="bg-red-50 border-l-4 border-red-400 rounded-r-lg p-5">
            ...
            <p className="text-[13px] text-stone-700 mt-2 italic">
              Scenario: TA Manager says "We'll evaluate ATS options next year when our BambooHR contract is up."
            </p>
...
And here's the thing — Teamtailor isn't locked to your 
BambooHR contract. BambooHR is your HRIS. We're your 
ATS. They integrate, they don't compete. You can start 
...
costs you between now and next year?"`}
          ...
          <div className="bg-orange-50 border-l-4 border-orange-400 rounded-r-lg p-5">
            ...
            <p className="text-[13px] text-stone-700 mt-2 italic">
              Scenario: They're evaluating Greenhouse and Lever alongside Teamtailor.
            </p>
...
every other job board. Teamtailor was BUILT around 
...
license. Teamtailor is flat-fee, unlimited users, 
...
worrying about license costs?"`}
          ...
          <div className="bg-yellow-50 border-l-4 border-yellow-400 rounded-r-lg p-5">
            ...
            <p className="text-[13px] text-stone-700 mt-2 italic">
              Scenario: They say "$10K/year feels expensive for an ATS."
            </p>
...
If Teamtailor eliminates even HALF of that — that's 
...
conversations and I want to help with the right one."`}
          ...
          <div className="bg-purple-50 border-l-4 border-purple-400 rounded-r-lg p-5">
            ...
            <p className="text-[13px] text-stone-700 mt-2 italic">
              Scenario: They say "We're a 2,000-person company — Teamtailor seems like it's for smaller businesses."
            </p>
...
not scale? Let me address that directly."`}
          ...
          <div className="bg-indigo-50 border-l-4 border-indigo-400 rounded-r-lg p-5">
            ...
            <p className="text-[13px] text-stone-700 mt-2 italic">
              Scenario: HR Director loves Teamtailor but says "I need to convince our CFO and she won't take a demo."
            </p>
...
internally. You're not selling Teamtailor — you're 
...
have this ready before then."`}
      ...
      <DocSection title="🟦 TT Deal Health Diagnostic — Pre-Proposal Self-Assessment">
        <p>Before you hit send on ANY Teamtailor proposal, score yourself honestly on these questions:</p>
        ...
        <Callout type="rule" title="Scoring: 10+ Checks = Green Light | 7-9 = Yellow | Under 7 = DOA">
          If you can't check 10 or more of these 12 boxes, your proposal is at risk. Go back and fill the gaps before sending. A DOA proposal doesn't just waste your time — it trains the prospect to see ATS vendors as interchangeable, making the next vendor's job easier.
        </Callout>
      </DocSection>
