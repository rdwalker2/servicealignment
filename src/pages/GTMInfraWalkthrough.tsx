    ...
    <div style={{ fontFamily: "'Inter', system-ui, -apple-system, sans-serif", background: '#fafaf9', minHeight: '100vh' }}>
      ...
      <header style={{
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', position: 'relative' }}>
          ...
          <div style={{ display: 'flex', gap: 32, marginTop: 48, flexWrap: 'wrap' }}>
            {[
              { value: '2,722', label: 'Rippling Accounts', sub: 'Verified Provider users' },
      ...
      <section style={{ ...sectionStyle }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 0, position: 'relative' }}>
          {[
            { num: '1', icon: '🔍', title: 'Audience Discovery', desc: 'Google dorking via Apify, TheirStack API, Clearbit domain resolution. Accounts land in Supabase with Provider, employee count, industry, location.', who: 'AI-Assisted', color: ACCENT },
          ...
          <div style={{ ...cardStyle, marginBottom: 24 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12 }}>
              {[
                ...
                { source: 'Rippling Provider', key: 'rippling', count: '2,722', color: ACCENT },
                { source: 'Greenhouse Provider', key: 'greenhouse', count: '291', color: GREEN },
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.78rem' }}>
              ...
              <tbody>
                {[
                  ...
                  { field: 'Current Provider', api: 'Current_ATS_Provider__c', rip: 100, gh: 100, k12: 98, why: 'Core targeting field for ads' },
      ...
      <section style={sectionStyle}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: 20, marginBottom: 32 }}>
          {[
            ...
            { num: '2', title: 'Enrich in Clay', desc: 'Enrichment config is ready: Company Lookup (HQ, employees, industry, revenue), VP/Director TA finding, CHRO/VP People finding, Provider detection. ~6 credits per account.' },
      ...
      <section style={{ background: '#f5f3f0', padding: '64px 0' }}>
        <div style={sectionStyle}>
          ...
          <p style={{ ...bodyStyle, maxWidth: 720, marginBottom: 12 }}>
            Walk-through of a real scenario: a VP of Talent Acquisition from a B2B SaaS company visits servicealignment.com/pricing. The contact doesn't exist in Salesforce, and the account has no owner. Here's exactly what happens, step by step.
          </p>
            ...
            <div style={{ display: 'flex', gap: 20, alignItems: 'center' }}>
              ...
              <div>
                ...
                <div style={{ display: 'flex', gap: 8, marginTop: 6 }}>
                  <span style={{ fontSize: '0.72rem', fontWeight: 600, background: `${ACCENT}15`, color: ACCENT, padding: '2px 8px', borderRadius: 4 }}>Rippling Provider</span>
            ...
            {[
              {
                ...
                detail: 'Sarah visits servicealignment.com/pricing. RB2B\'s JavaScript pixel matches her IP to her LinkedIn profile via reverse-IP resolution. RB2B fires a webhook to our server with her name, email, company, and the page she visited.',
              ...
              },
              {
                ...
                time: '< 1 second',
                detail: 'The system scores the signal — it never hard-rejects. Acme Cloud has 340 employees (sweet spot, +15), Rippling Provider (direct competitor, +30), and Sarah visited the pricing page (+20). Total: 92/100, tier: "hot." A visitor from a 15,000-person company with no known Provider would still get through — they\'d just score lower (55, "monitor") instead of being blocked.',
                technical: 'flywheel.js scores: base 50 + Provider match + employee range + pricing page visit → score 92, icp_tier: "hot". Only ISP/freemail domains (gmail, yahoo) are dropped.',
                color: '#8b5cf6',
              },
              {
                num: '3',
          ...
          <div style={{ marginTop: 32 }}>
            ...
            <div style={{ ...cardStyle, overflow: 'hidden', padding: 0 }}>
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem' }}>
                <thead>
                  <tr style={{ background: '#f9fafb' }}>
                    {['', 'Contact', 'Organization', 'Score', 'Signals', 'Web Activity', 'Provider', 'Stage'].map(h => (
                ...
                <tbody>
                  <tr style={{ background: '#fefce8', borderBottom: '1px solid #fde68a' }}>
                    ...
                    <td style={{ padding: '12px 14px' }}>
                      <div style={{ fontSize: '0.78rem', color: '#374151', fontWeight: 500 }}>🔴 Pricing page visit · Rippling Provider user</div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 20, marginTop: 24 }}>
          ...
          <div style={{ ...cardStyle, borderTop: `3px solid ${ACCENT}` }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 20 }}>
              {[
                { label: 'Still on Rippling Provider', value: '85% (2,327)' },
          ...
          <div style={{ ...cardStyle, borderTop: `3px solid ${GREEN}` }}>
            ...
            <div style={{ background: '#ecfdf5', borderRadius: 8, padding: 16, marginTop: 12 }}>
              ...
              <div style={{ fontSize: '0.78rem', color: '#047857', marginTop: 4 }}>
                200 accounts (100 per AE), 200-500 employees, Greenhouse Provider. Enrichment in progress — employee counts, industry, location.
              </div>
            </div>
          ...
          <div style={{ ...cardStyle, borderTop: '3px solid #f59e0b' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 20 }}>
              {[
                ...
                { label: 'Provider coverage', value: 'Scan in progress' },
            ...
            <div style={{ background: '#fffbeb', borderRadius: 8, padding: 16, marginTop: 12 }}>
              <div style={{ fontSize: '0.82rem', fontWeight: 600, color: '#92400e' }}>New Vertical for Service Alignment</div>
              <div style={{ fontSize: '0.78rem', color: '#a16207', marginTop: 4 }}>
                K-12 districts are a largely untapped market for modern Provider. Same enrichment pipeline as Rippling/Greenhouse — ready for Clay enrichment and ad targeting.
              </div>
            </div>
      ...
      <section style={sectionStyle}>
        ...
        <div style={{ ...cardStyle, overflow: 'hidden', padding: 0 }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.78rem' }}>
            <thead>
              <tr style={{ background: '#f9fafb' }}>
                {['Company', 'Domain', 'Employees', 'Industry', 'Provider', 'Location', 'Source'].map(h => (
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
            ...
            <div style={{ background: GRADIENT_1, borderRadius: 12, padding: 28, color: 'white' }}>
              ...
              <div style={{ fontFamily: 'monospace', fontSize: '0.8rem', lineHeight: 2.2 }}>
                ...
                <div style={{ color: GREEN, wordBreak: 'break-all' as const }}>https://servicealignment-gtm-workspace-production.up.railway.app/api/webhook/clay</div>
      ...
      <section style={sectionStyle}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, marginTop: 24 }}>
          ...
          <div style={{ ...cardStyle, borderTop: `3px solid ${AMBER}` }}>
            ...
            {[
              { item: 'No direct Supabase → SFDC', desc: 'Connected App requires internal legal/IT approval at Service Alignment. Timeline: end of August. Clay bridges the gap until then.' },
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 60px 1fr', gap: 0 }}>
            ...
            <div style={{ padding: 24 }}>
              ...
              {[
                ...
                { field: 'Current_ATS_Provider__c', why: 'Competitive Provider — drives targeting priority (Rippling, Greenhouse, etc.)' },
                { field: 'Current Provider Renewal Date', why: 'Times outreach 3-6 months before contract renewal' },
            ...
            <div style={{ padding: 24 }}>
              ...
              {[
                ...
                { field: 'Current_ATS_Provider__c', why: 'Provider detected via BuiltWith/career page scraping — fills gaps in SFDC data', sensitivity: 'Low' },
      ...
      <footer style={{ padding: '32px 0', textAlign: 'center', fontSize: '0.78rem', color: '#9ca3af' }}>
        Service Alignment GTM Workspace · July 2026
      </footer>
    </div>
  );
}
