...
interface TrainingLink { label: string; tab: TabId; section: string; icon: React.ReactNode }
...
const STAGES: FunnelStage[] = [
  {
    ...
    techniques: [
      ...
      'Research the career page before dialing — know what HRIS/ATS they use before the call',
  ...
  },
  {
    ...
    techniques: [
      ...
      'Wave 3: "When was the last time you actually evaluated your ATS against what\'s on the market?"',
  ...
  },
  {
    ...
    techniques: [
      ...
      'Personalize the invite subject: "[Prospect First Name] + [Your Name] — HR Space Innovations" (not "Teamtailor Demo")',
  ...
  },
  {
    ...
    training: [
      { label: 'Three Checkpoints', tab: 'rep-workbook', section: 'three-checkpoints', icon: <CheckCircle2 size={14} /> },
      { label: 'Five Fatalities', tab: 'rep-workbook', section: 'five-fatalities', icon: <AlertTriangle size={14} /> },
  ...
  },
  {
    ...
    training: [
      { label: 'Five Fatalities — Pre-Mortem', tab: 'rep-workbook', section: 'five-fatalities', icon: <AlertTriangle size={14} /> },
      { label: 'Three Checkpoints', tab: 'rep-workbook', section: 'three-checkpoints', icon: <CheckCircle2 size={14} /> },
    ],
  },
];
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[11px] text-stone-500">
                      {link.tab === 'cold-call-playbook' ? 'Cold Call Playbook' :
                       link.tab === 'rep-workbook' ? 'Rep Workbook' : 'Discovery Sheets'}
                    </p>
                  </div>
