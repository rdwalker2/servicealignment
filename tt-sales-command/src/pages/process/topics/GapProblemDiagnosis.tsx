  ...
  return (
    <div className="p-10 max-w-4xl mx-auto h-full overflow-y-auto pb-32">
      ...
      <DocSection title="Bigger Problems → Higher Price: TT Examples">
        <p className="mb-4">Here's how reframing the problem creates price justification in a Teamtailor deal:</p>
        <div className="space-y-4">
          <div className="border-l-4 border-amber-400 pl-4 py-3 bg-amber-50/30 rounded-r-lg">
            <p className="font-semibold text-stone-800">Surface: {`"We need a new ATS"`}</p>
...
"What percentage of your hiring managers actually log into your ATS? Or are they working through email and Slack?"
...
Most [vendors/teams/companies] are trying to solve [surface problem], but the reason it keeps coming back is [root cause that aligns with your special sauce]."`}
        ...
        <h4 className="font-bold text-stone-800 mt-6 mb-2">Teamtailor-Specific Diagnostic Statements</h4>
        <p className="mb-4">Use these reframes when you've identified the root cause. Each one connects the surface symptom to the bigger problem that Teamtailor uniquely solves.</p>
...
When Motorpoint had this same issue, they weren't actually understaffed in recruiting — their tools were just creating 3x the admin work. Once they moved to Teamtailor, they cut time-to-hire by 58% without adding headcount.
...
Companies like L'Occitane, operating across 20 countries, use Teamtailor to make every career page feel like a premium brand experience. The result? Candidates actually want to apply — and they stay engaged through the process."`}
        </ScriptBlock>
      </DocSection>
      ...
      <DocSection title="TT Specialist Positioning">
        <p className="mb-4">At Teamtailor, your specialist positioning comes from three unique capabilities no HRIS ATS or legacy platform can match:</p>
        <div className="space-y-4">
          ...
          <div className="border-l-4 border-violet-400 pl-4 py-3 bg-violet-50/30 rounded-r-lg">
            ...
            <p className="text-sm text-stone-700">
              Most ATS tools are back-office systems. Teamtailor is a candidate-facing platform. Your career site, your employer brand content, your application experience — it's all designed to convert visitors into applicants. That's our special sauce. Diagnose the career site gap and you create demand for what only TT delivers.
            </p>
          </div>
          <div className="border-l-4 border-emerald-400 pl-4 py-3 bg-emerald-50/30 rounded-r-lg">
