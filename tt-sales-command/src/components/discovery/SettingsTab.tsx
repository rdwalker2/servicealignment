  ...
  const renderConfig = (key: SectionKey): React.ReactNode | null => {
    switch (key) {
      ...
      case 'competitive': {
        ...
        // Competitors available to select (exclude 'None', 'other', and the current ATS)
        ...
        return (
          <div className="space-y-4">
            ...
            {/* Current ATS — pulled from session, read-only display */}
            <div>
            ...
            <div className="rounded-xl border border-stone-200 bg-white p-4">
              {industryCount > 0 && (
                <div className="mb-4 rounded-lg bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200 px-4 py-3">
                  <p className="text-xs font-bold text-emerald-700">🎯 {industryCount} {industryLabel} companies already use Teamtailor</p>
