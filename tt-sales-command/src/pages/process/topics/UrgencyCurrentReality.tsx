...
export default function UrgencyCurrentReality() {
  return (
    <div className="p-10 max-w-4xl mx-auto h-full overflow-y-auto pb-32">
      ...
      <DocSection title="The Five ATS/Hiring Response Patterns">
        <p className="mb-4">In ATS and hiring conversations, prospects almost always describe their current reality using one of these five patterns. Each one requires a specific follow-up to expose the gap:</p>
        ...
        <div className="space-y-5">
          <div className="border-l-4 border-amber-400 pl-4 py-3 bg-amber-50/30 rounded-r-lg">
            ...
            <Callout type="info" title="What You're Exposing">
              No employer brand, no SEO, no conversion optimization, no applicant tracking. Their "careers page" is a dead end that forces manual work. Companies like Motorpoint saw a 58% reduction in time-to-hire by replacing this approach with an integrated career site and ATS.
            </Callout>
          </div>

          <div className="border-l-4 border-blue-400 pl-4 py-3 bg-blue-50/30 rounded-r-lg">
            <h4 className="font-bold text-stone-900 mb-2">Pattern 2: "We've been using our HRIS's ATS module"</h4>
            <p className="text-sm text-stone-600 mb-3">They're on ADP, Paycom, BambooHR, or similar — and using the recruiting add-on that was never built to be a real ATS.</p>
            <ScriptBlock label="Follow-Up Script">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-start gap-3 p-3 bg-stone-50 rounded-lg border border-stone-200">
            ...
            <div>
              ...
              <p className="text-[13px] text-stone-600">What's their current tech stack? HRIS with recruiting add-on, standalone ATS, spreadsheets? Are they locked into a contract?</p>
            </div>
          </div>
          <div className="flex items-start gap-3 p-3 bg-stone-50 rounded-lg border border-stone-200">
            <span className="text-stone-400 mt-0.5 shrink-0">☐</span>
