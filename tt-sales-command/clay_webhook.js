      ...
      if (result.status === 'skipped') {
        ...
        if (result.domain && (result.actions?.includes('account_upserted') || result.actions?.includes('signal_inserted'))) {
          try {
            ...
            if (routing.assigned) routingResults.push({ domain: result.domain, assigned_rep_id: routing.repId, rep_name: routing.repName, sf_user_id: routing.sfUserId || null, method: routing.method });
          } catch (routeErr) {
