    ...
    <div className="w-full mt-12 pt-12 border-t border-zinc-200/60">
      <div className="mb-12 text-center">
        ...
        <p className="mt-3 text-zinc-500 max-w-2xl mx-auto">
          You don't have to take our word for it. Here is how Service Alignment is actively solving the exact challenges you identified, according to verified users on G2 and Capterra.
        </p>
