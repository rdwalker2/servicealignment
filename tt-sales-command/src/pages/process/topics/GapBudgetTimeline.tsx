...
continuing to figure it out each time a role opens?"`}
      ...
      <DocSection title="The TT Cost of Inaction Calculator">
        ...
        <ScriptBlock label="Cost of Inaction Talk Track">
          {`"Before we talk about what Teamtailor costs, let me ask you — what's the current process costing you?
...
When you add it all up, the question isn't whether you can afford Teamtailor. The question is whether you can afford to keep going without it."`}
        </ScriptBlock>
      </DocSection>
        ...
        <div className="space-y-4">
          <div className="border-l-4 border-violet-400 pl-4 py-3 bg-violet-50/30 rounded-r-lg">
            ...
            <ScriptBlock label="CEO/CFO Budget Frame">
              {`"For a company your size hiring 50-80 people a year, most of my customers are investing between £15-30K annually in Teamtailor. Compare that to what you're spending on agencies alone — typically £150-200K — and you're looking at a 5-10x return in year one just from reduced agency dependency.
...
That doesn't even account for the productivity gains from AI screening or the revenue impact of filling roles faster."`}
          ...
          <div className="border-l-4 border-cyan-400 pl-4 py-3 bg-cyan-50/30 rounded-r-lg">
            ...
            <ScriptBlock label="HR Director Budget Frame">
              {`"The way I'd think about this is: Teamtailor isn't a cost — it's giving your team capacity back. Companies like Motorpoint saw their recruiters handle 3x the volume without adding headcount. That's the equivalent of hiring 2-3 more recruiters without the salary cost.
...
What would your team be able to accomplish if they had 40 hours a week back from manual screening?"`}
          ...
          <div className="border-l-4 border-amber-400 pl-4 py-3 bg-amber-50/30 rounded-r-lg">
            ...
            <ScriptBlock label="Ops Manager Budget Frame">
              {`"I know recruiting isn't your full-time job — you're wearing 10 hats. The value of Teamtailor for someone in your role is that it takes recruiting off your plate without needing to hire someone for it.
...
Does that timeline work for you?"`}
      ...
      <DocSection title="TT Natural Deadline Triggers">
        <p className="mb-4">These are the most common timeline triggers in Teamtailor deals. Listen for them and use them to create natural urgency:</p>
        <div className="space-y-3">
          ...
          <div className="border-l-4 border-emerald-400 pl-4 py-3 bg-emerald-50/30 rounded-r-lg">
            <h4 className="font-bold text-stone-900 mb-1">🔄 Current ATS Contract Renewal</h4>
