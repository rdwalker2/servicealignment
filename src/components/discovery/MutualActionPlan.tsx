...
const DEFAULT_MILESTONES: MAPMilestone[] = [
  ...
  { id: '2', label: 'Tailored Demo', owner: 'Service Alignment', dueDate: '', done: false },
  { id: '3', label: 'Business Case Review', owner: '', dueDate: '', done: false },
  { id: '4', label: 'Commercial Proposal', owner: 'Service Alignment', dueDate: '', done: false },
  { id: '5', label: 'Contract Sign Off', owner: '', dueDate: '', done: false },
  { id: '6', label: 'Onboarding', owner: 'Service Alignment', dueDate: '', done: false },
];
    ...
    <div className="w-full">
      ...
      {!hideHeader && (
        <div className="mb-10 text-center">
          ...
          >
            A shared checklist for {session.company_name} and Service Alignment to reach launch day together. Edit any step, add owners, and set target dates.
          </motion.p>
        </div>
      )}
