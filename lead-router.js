  ...
  try {
    ...
    if (account?.sf_account_owner) {
      ...
      if (sfdcRep?.is_active) {
        ...
        return { assigned: true, repId: sfdcRep.rep_id, repName: sfdcRep.full_name, sfUserId: sfdcRep.sf_user_id, sfAccountId: account?.sf_account_id, method: 'sfdc_owner' };
      }
    }
    ...
    if (account?.assigned_rep_id) {
      ...
      if (rep?.is_active && rep?.is_available) {
        ...
        return { assigned: true, repId: rep.rep_id, repName: rep.full_name, sfUserId: rep.sf_user_id, sfAccountId: account?.sf_account_id, method: 'sticky' };
      }
    ...
    if (rep) {
      ...
      return { assigned: true, repId: rep.rep_id, repName: rep.full_name, sfUserId: rep.sf_user_id, sfAccountId: account?.sf_account_id, method: 'round_robin' };
    }
