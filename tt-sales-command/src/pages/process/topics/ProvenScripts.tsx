...
{`"Hi [First Name], it's [Your Name] from Teamtailor, the applicant management
platform. Hope you're doing well."`}
            </ScriptBlock>
            <p className="text-[12px] text-stone-500 italic">Note: "Applicant management platform" not "ATS" — less triggering.</p>
...
tools and applicant management internally, correct?"`}
            ...
            <p className="text-[12px] text-stone-500 italic">Don't pitch a gatekeeper. Get the yes before you continue.</p>
...
on hand whenever you want to compare."`}
            ...
            <p className="text-[12px] text-stone-500 italic">Key phrases: "innovations in the HR space" · "no commitment" · "so you have the information on hand" · "whenever you want to compare" — each word is intentional.</p>
...
week after? I can do [Tuesday] at [10] or [2] — what works better?"`}
            ...
            <p className="text-[12px] text-stone-500 italic">Two slots only. Never "when are you free?" Binary choice = faster decision.</p>
          </div>
        </div>
      </DocSection>
...
HR side of it. When it comes to the applicant tracking system side — I've
...
Sometimes I hear when it comes to the applicant tracking system side — it
...
{`"So what companies do is use Teamtailor for the ATS — and once the
          ...
          {[
            {
              ...
              repLine: '"When it comes to the ATS side, it can be seen as a bit of an afterthought Kelsey. Just kind of curious if that resonates with you at all."',
              prospectLine: '"Yeah, it absolutely does. Our applicant tracking system sucks."',
              repFollow: null,
            },
            {
              rep: 'Chris Smith',
              target: 'Ryan — using Dayforce/Axiom',
              repLine: '"I hear really good things about Dayforce from an HRIS side. I hear when it comes to the applicant tracking system side, it can be seen as a bit of an afterthought."',
            ...
            },
            {
              ...
              repLine: '"I hear wonderful things about UltiPro from the HR side of it. When it comes to the applicant tracking system side, I\'ve heard it can be seen as a bit of an afterthought. Just curious if that resonates with you at all."',
              prospectLine: '"A bit. It does the job, but it certainly doesn\'t have some of the functionality that dedicated ATS platforms would have."',
              repFollow: null,
            },
            {
              rep: 'Chris Smith',
            ...
            },
            {
              ...
              repLine: '"I work with a lot of teams who just find that the Dayforce ATS isn\'t meeting their needs. So they move over to our system for recruiting... Have you had any conversations about the ATS not meeting your needs?"',
      ...
      <DocSection title="Recovery Techniques After 'No'">
        ...
        <div className="space-y-3 mt-2">
          ...
          <div className="rounded-lg border border-blue-200 overflow-hidden">
            ...
            <div className="p-4">
              <p className="text-[13px] text-stone-700 italic">"Most people I talked to say exactly what you say, hey, we're not in a position to make a change right now... Sometimes I show people Teamtailor and they call me back in like a year or two... Let's just say in a year from today, you are in a position to change — it's like, oh, I saw Teamtailor that actually looked pretty cool, solving A, B and C."</p>
          ...
          <div className="rounded-lg border border-amber-200 overflow-hidden">
            ...
            <div className="p-4">
              <p className="text-[13px] text-stone-700 italic">"We could keep this conversation like educational and keep it passive right now since you guys don't aggressively making a change. But that way you know what's out there. You could see Teamtailor, whether you like it or not."</p>
...
HRIS from the ATS? That usually shapes which direction is the right move."`}
        </ScriptBlock>

        <ScriptBlock label={`"Send me an email"`}>
{`"Absolutely, I'll send it right now. While I have you — what's the one thing
you wish your current ATS did better? I'll make sure whatever I send is
...
{`"I'd love to show you a little what Teamtailor looks like, especially from
...
it. Do you think we can complement some of your current processes?"`}
        ...
        <p className="text-[12px] text-stone-500 italic">"Get your opinion" + "complement" = no threat. They're just looking, not buying.</p>
...
is I share my screen with you, show you what Teamtailor looks like. You could
...
wouldn't even need to waste time to talk to a decision maker."`}
        ...
        <p className="text-[12px] text-stone-500 italic">Pre-disqualifies the pitch. "You can say no and we're done." Removes all fear of commitment.</p>

        <ScriptBlock label="20-Minute Educational Close">
{`"Would you maybe later this week or early next week have like 20 minutes?
I'll share my screen with you, show you Teamtailor looks like just to get
...
the conversation. If not, we just part ways as friends."`}
        ...
        <p className="text-[12px] text-stone-500 italic">"Part ways as friends" — the easiest yes in cold calling. Zero risk, zero commitment.</p>
      </DocSection>
        ...
        <div className="overflow-x-auto mt-2">
          <table className="w-full text-[13px]">
            ...
            <tbody className="text-stone-600">
              {[
                { hris: 'ADP Workforce Now', angle: 'ADP Marketplace partner — keep ADP for payroll, replace ATS', integration: '✅ Native' },
                { hris: 'Paylocity', angle: 'ATS is their biggest weak point. Keep payroll, replace ATS.', integration: '✅ API' },
                { hris: 'BambooHR', angle: 'Recruiting was acquired and never rebuilt. Keep HR — replace recruiting.', integration: '✅ API' },
                { hris: 'Rippling', angle: 'Excellent for HRIS/payroll. ATS is an add-on module, not their focus.', integration: '✅ API' },
                { hris: 'Gusto', angle: 'Payroll-first. Their ATS is basic. Easy integration with TT.', integration: '✅ Native' },
                { hris: 'Workday', angle: 'Enterprise HRIS. ATS is functional but clunky — "afterthought" resonates.', integration: '✅ API' },
                { hris: 'Dayforce / Ceridian', angle: 'HRIS-first with bolted-on ATS. Same wedge play applies.', integration: '✅ API' },
                { hris: 'UKG', angle: 'HRIS-first. Recruiting module is cumbersome. Use "cumbersome" not "afterthought."', integration: '✅ API' },
                { hris: 'isolved / Paycom / Paycor', angle: 'All HRIS-first platforms with bolted-on ATS.', integration: '✅ API' },
              ].map((row, i) => (
...
to actually engage with candidates?"`}
        ...
        <p className="text-[12px] text-stone-500 italic">More specific = more likely to land. Tailor to what you know about their company size.</p>
      </DocSection>
    </div>
  );
}
