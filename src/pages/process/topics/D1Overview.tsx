...
export default function D1Overview() {
  return (
    <div className="p-10 max-w-4xl mx-auto h-full overflow-y-auto pb-32">
      ...
      <DocSection title="The Six Urgency Test Objectives">
        <p className="mb-4">These six steps can be repeated time and time again to get to the pain in each of your prospects — if that pain actually exists:</p>
        <div className="space-y-4">
          <div className="border-l-4 border-amber-400 pl-4 py-3 bg-amber-50/30 rounded-r-lg">
            <h4 className="font-bold text-stone-900 mb-1">1. Initiative</h4>
            <p className="text-[14px] text-stone-600">
              They scheduled and attended this meeting, spending time and energy with a stranger, for a reason. That is a huge tell. <em>What strategic initiative are they trying to achieve, or what specific problem are they trying to solve?</em> This is the small domino that knocks down all the bigger dominoes.
            </p>
          </div>
          <div className="border-l-4 border-orange-400 pl-4 py-3 bg-orange-50/30 rounded-r-lg">
            <h4 className="font-bold text-stone-900 mb-1">2. Priority</h4>
            <p className="text-[14px] text-stone-600">
              How critical is this initiative to them right now? Use the 1-10 priority scale to gut-check their stated pain against their urgency rating. If it's a low priority, you must either elevate it or disqualify the prospect.
            </p>
          </div>
          <div className="border-l-4 border-blue-400 pl-4 py-3 bg-blue-50/30 rounded-r-lg">
            <h4 className="font-bold text-stone-900 mb-1">3. Process</h4>
            <p className="text-[14px] text-stone-600">
              What does their current process look like from start to finish? Map out the steps, identify where it breaks down, and pinpoint exactly what is eating up most of their time and resources.
            </p>
          </div>
          <div className="border-l-4 border-violet-400 pl-4 py-3 bg-violet-50/30 rounded-r-lg">
            <h4 className="font-bold text-stone-900 mb-1">4. Stakeholders</h4>
            <p className="text-[14px] text-stone-600">
              Who is responsible for solving this problem? Who owns it? Who has the authority to make decisions and approve budgets? Map the decision-making chain early.
            </p>
          </div>
          <div className="border-l-4 border-teal-400 pl-4 py-3 bg-teal-50/30 rounded-r-lg">
            <h4 className="font-bold text-stone-900 mb-1">5. Infrastructure</h4>
            <p className="text-[14px] text-stone-600">
              What tools, systems, or HRIS do they currently have in place? How long have they been using them, and where are the critical gaps? This establishes the current reality and identifies displacement opportunities.
            </p>
          </div>
          <div className="border-l-4 border-rose-400 pl-4 py-3 bg-rose-50/30 rounded-r-lg">
            <h4 className="font-bold text-stone-900 mb-1">6. Inaction Cost</h4>
            <p className="text-[14px] text-stone-600">
              What is the realistic worst-case scenario if they continue failing to solve this? Quantify the cost of open roles, lost productivity, and delayed launches.
            </p>
          </div>
        </div>
      </DocSection>
      ...
      <DocSection title="Before the Four Objectives: Take Leadership">
        <p>
          Before diving into the six objectives, you must take leadership position at the top of the call. Sales calls can be a waste of time for prospects, and more and more will try to take control to ensure they get value.
        </p>
        <p className="mt-3">
...
4. Transition directly into Objective #1`}
      ...
      <DocSection title="The Discovery Flow">
        ...
        <div className="mt-4 p-4 bg-stone-50 rounded-lg border border-stone-200">
          <ol className="space-y-2 text-[14px]">
            <li><strong>1. Initiative:</strong> What problem are you trying to solve or what strategic goal are you targeting?</li>
            <li><strong>2. Priority:</strong> On a scale of 1 to 10, how much of a priority is fixing this for your team right now?</li>
            <li><strong>3. Process:</strong> Walk me through what happens from the moment a role opens to the moment someone accepts an offer. Where does it get stuck?</li>
            <li><strong>4. Stakeholders:</strong> Who is responsible for solving that problem and who has the authority to make a decision?</li>
            <li><strong>5. Infrastructure:</strong> What tools and systems do you already have in place to handle this, and where are they falling short?</li>
            <li><strong>6. Inaction Cost:</strong> If that trend continues and this problem doesn't get solved, realistically speaking, what's the worst thing that will happen?</li>
          </ol>
        </div>
      ...
      <DocSection title="What a GOOD vs BAD D1 Sounds Like at Service Alignment">
        ...
        <div className="space-y-4">
          ...
          <div className="border-l-4 border-rose-500 pl-4 py-3 bg-rose-50/30 rounded-r-lg">
            ...
            <div className="text-[14px] text-stone-700 space-y-2">
              <p><strong>Rep:</strong> "So let me tell you about Service Alignment — we're an all-in-one Provider with AI-powered screening, beautiful career sites, and we process over 6 million applications..."</p>
      ...
      <DocSection title="D1 Success Criteria Checklist">
        <p className="mb-4">Before ending D1 and advancing to D2, you must be able to answer <strong>all six</strong> of these. If you can't, you haven't finished Discovery:</p>
        <div className="space-y-2">
          <div className="flex items-start gap-3 p-3 bg-stone-50 rounded-lg border border-stone-200">
            ...
            <div>
              <p className="font-semibold text-stone-800">1. Initiative</p>
              <p className="text-[13px] text-stone-600">What specific hiring/recruiting problem are they trying to solve?</p>
          ...
          <div className="flex items-start gap-3 p-3 bg-stone-50 rounded-lg border border-stone-200">
            <span className="text-stone-400 mt-0.5 shrink-0">☐</span>
            <div>
              <p className="font-semibold text-stone-800">2. Priority</p>
              <p className="text-[13px] text-stone-600">How urgent is this compared to everything else on their plate?</p>
              <p className="text-[12px] text-stone-500 mt-1 italic">Example: "Rated an 8/10 because it's actively blocking revenue generation."</p>
            </div>
          </div>
          <div className="flex items-start gap-3 p-3 bg-stone-50 rounded-lg border border-stone-200">
            <span className="text-stone-400 mt-0.5 shrink-0">☐</span>
            <div>
              <p className="font-semibold text-stone-800">3. Process</p>
              <p className="text-[13px] text-stone-600">How are they doing things today, and exactly where does the workflow break down?</p>
              <p className="text-[12px] text-stone-500 mt-1 italic">Example: "Currently manually screening resumes and using spreadsheets. Stalling out at HM feedback."</p>
            </div>
          </div>
          <div className="flex items-start gap-3 p-3 bg-stone-50 rounded-lg border border-stone-200">
            <span className="text-stone-400 mt-0.5 shrink-0">☐</span>
            <div>
              <p className="font-semibold text-stone-800">4. Stakeholders</p>
          ...
          <div className="flex items-start gap-3 p-3 bg-stone-50 rounded-lg border border-stone-200">
            <span className="text-stone-400 mt-0.5 shrink-0">☐</span>
            <div>
              <p className="font-semibold text-stone-800">5. Infrastructure</p>
              <p className="text-[13px] text-stone-600">What solutions, tools, or HRIS do they currently use, and why aren't they enough?</p>
              <p className="text-[12px] text-stone-500 mt-1 italic">Example: "Using ADP's recruiting module + manual Indeed postings. No automation, no employer brand."</p>
            </div>
          </div>
          <div className="flex items-start gap-3 p-3 bg-stone-50 rounded-lg border border-stone-200">
            <span className="text-stone-400 mt-0.5 shrink-0">☐</span>
            <div>
              <p className="font-semibold text-stone-800">6. Inaction Cost</p>
              <p className="text-[13px] text-stone-600">What happens if this doesn't get solved? Have they quantified the impact?</p>
              <p className="text-[12px] text-stone-500 mt-1 italic">Example: "They delay two store openings — each unfilled role costs ~$400-500/day in lost productivity."</p>
            </div>
          </div>
        </div>
      </DocSection>
      ...
      <DocSection title="How the D1 Discovery Flow Sounds in a TT Context">
        <p>The four objectives aren't standalone questions — they're a connected diagnostic conversation. Here's how they flow together in a typical Service Alignment deal (for full diagnostic questions, see the Date vs. Doctor topic):</p>
        ...
        <div className="mt-4 space-y-3">
          ...
          <div className="flex items-start gap-3 p-3 bg-blue-50/50 rounded-lg border border-blue-100">
            ...
            <div>
              ...
              <p className="text-[13px] text-stone-500 mt-1"><strong>→ D2 Gap:</strong> Use this in Budget &amp; Timeline gap — $96K/year in agency fees is 6-8x what a Service Alignment subscription costs. The ROI case writes itself.</p>
            </div>
          </div>
          <div className="flex items-start gap-3 p-3 bg-blue-50/50 rounded-lg border border-blue-100">
            <span className="font-bold text-blue-600 text-sm mt-0.5 shrink-0">D1:</span>
