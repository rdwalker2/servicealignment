    ...
    <div className="p-10 max-w-4xl mx-auto h-full overflow-y-auto pb-32">
      ...
      <DocSection title="The Rule of 3">
        ...
        <div className="bg-stone-900 border border-stone-700 rounded-lg p-5 mt-4">
          <h4 className="font-bold text-white mb-3 text-[14px]">Teamtailor's Method — The Rule of 3</h4>
      ...
      <DocSection title="Connecting the Dots: Talk Track">
        <ScriptBlock label="Solution Presentation — Teamtailor">
        ...
        <div className="mt-4 overflow-x-auto">
          ...
          <table className="w-full text-[12px]">
            ...
            <tbody>
              ...
              <tr>
                <td className="py-2 px-3 italic text-stone-600">"Our ATS / HRIS is an afterthought"</td>
                <td className="py-2 px-3 font-bold text-emerald-600">Attract</td>
                <td className="py-2 px-3 text-stone-700">Full platform tour — show what a dedicated ATS looks like</td>
              </tr>
            </tbody>
          </table>
        </div>
