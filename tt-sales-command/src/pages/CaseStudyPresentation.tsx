                    ...
                    <section className="space-y-6">
                        ...
                        <div className="text-stone-600 leading-relaxed space-y-4">
                            ...
                            <ul className="list-disc pl-5 space-y-2 mt-4 text-stone-700">
                                ...
                                <li><strong className="text-stone-900">Tech Stack Intent:</strong> Automatically identifies companies using outdated ATS platforms (e.g., Workday, Greenhouse) that are ripe for displacement.</li>
                            </ul>
