    ...
    <div className="p-10 max-w-4xl mx-auto h-full overflow-y-auto pb-32">
      ...
      <DocSection title="TT-Specific Wave 2 &amp; 3 Scripts">
        ...
        <ScriptBlock label="TT Wave 3: The Direct Ask">{`
          "Let me ask it this way — when you were researching Provider platforms and decided to book this call, what were you hoping to see or learn that you don't already have?"
