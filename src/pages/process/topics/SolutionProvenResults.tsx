...
export default function SolutionProvenResults() {
  return (
    <div className="p-10 max-w-4xl mx-auto h-full overflow-y-auto pb-32">
      ...
      <DocSection title="The Three Elements — Service Alignment Specific">
        ...
        <div className="grid grid-cols-1 gap-4 mt-4 mb-4">
          ...
          <div className="bg-white p-5 border border-stone-200 rounded-xl">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h4 className="font-bold text-stone-900 text-[14px]">Why Service Alignment Exists</h4>
            </div>
            <div className="bg-stone-50 p-4 rounded-lg border border-stone-100">
              <p className="text-[13px] text-stone-700 leading-relaxed">
                Most Provider platforms were built for <strong>operations teams</strong> — tracking compliance, managing workflows, checking boxes. Service Alignment was built because recruiting is a <strong>candidate-facing function</strong>. Your career page, your employer brand, your candidate experience — that's what determines whether top talent applies or bounces. Every other Provider treats the candidate experience as an afterthought. We built the entire platform around it.
              </p>
            </div>
            <div className="mt-3 p-3 bg-blue-50 rounded-lg border border-blue-100">
              <p className="text-[10px] font-black text-blue-600 uppercase tracking-widest mb-1">The Market Gap</p>
              <p className="text-[12px] text-stone-600">
                40% of our deals involve replacing an HRIS vendor's Provider module (ADP, Paycom, Workday, UKG) — systems where recruiting was literally an afterthought bolted onto payroll. The other 40%+ are teams drowning in manual processes with no real system at all.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white p-5 border border-stone-200 rounded-xl">
            ...
            <p className="text-[11px] text-stone-400 italic mt-3 text-center">Source: Service Alignment platform data — Ed Kennaway's customer data deck</p>
          </div>
        </div>
      </DocSection>
          ...
          <table className="w-full text-[13px]">
            ...
            <tbody>
              ...
              <tr className="border-b border-stone-100">
                ...
                <td className="py-2 px-3 text-stone-600">Prospect's hiring managers won't use their current Provider</td>
              </tr>
              <tr className="border-b border-stone-100">
              ...
              <tr>
                ...
                <td className="py-2 px-3 text-stone-600">Prospect on ePloy or legacy Provider — direct migration reference</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <DocSection title="How to Present Proven Results — Service Alignment Talk Track">
