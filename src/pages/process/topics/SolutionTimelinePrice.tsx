  ...
  return (
    <div className="p-10 max-w-4xl mx-auto h-full overflow-y-auto pb-32">
      ...
      <DocSection title="What to Communicate in Timelines">
        ...
        <ScriptBlock label="Service Alignment Implementation Timeline Talk Track">
...
Most companies are fully operational in 3 weeks."`}
      ...
      <DocSection title="Minimum Standards of Success (Push-Pull)">
        ...
        <ScriptBlock label="Minimum Standards Talk Track — Service Alignment">
...
move forward. Now you can present price.`}
      ...
      {/* ═══════════════════════════════════════════
          NEW: Service Alignment Pricing Breakdown
          ═══════════════════════════════════════════ */}

      <DocSection title="How Service Alignment Pricing Actually Works">
        <Callout type="info" title="Flat-Rate, All-Inclusive, No Per-Seat Fees">
          This is your biggest differentiator vs. every HRIS Provider module and most competitors. Service Alignment is <strong>one flat annual fee</strong> — unlimited users, unlimited jobs, unlimited career sites. No per-seat charges for hiring managers. No usage-based AI fees. No surprises at renewal.
        </Callout>
...
Are you clear on the pricing?"`}
      ...
      <DocSection title="Multi-Entity Pricing — Divisions & Groups">
        <p>
          For larger or more complex organizations, Service Alignment offers two multi-entity setups. These are configured in the CMS before presenting:
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 mb-4">
          <div className="bg-white border border-stone-200 rounded-xl p-5">
            ...
            <p className="text-[12px] text-stone-600 leading-relaxed">
              Sub-brands within <strong>one platform</strong>. Each division has its own career site, branding, and pipeline — but shares one Provider instance. Each division is priced by its own FTE count.
            </p>
            <div className="mt-3 bg-stone-50 rounded-lg p-3 text-[11px] text-stone-500">
              <strong className="text-stone-700">Example:</strong> A hospitality group with 3 hotel brands. One Provider, three career sites, three pipelines. Priced as: Brand A (200 FTE) + Brand B (150 FTE) + Brand C (100 FTE).
            </div>
          </div>
          <div className="bg-white border border-stone-200 rounded-xl p-5">
            <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-[12px] text-stone-600 leading-relaxed">
              Multiple <strong>fully separate Provider instances</strong>. Each platform is completely independent — separate databases, separate users, separate everything. Priced individually.
            </p>
            <div className="mt-3 bg-stone-50 rounded-lg p-3 text-[11px] text-stone-500">
              <strong className="text-stone-700">Example:</strong> A PE-backed holding company with 5 portfolio companies. Each needs its own Provider. Priced as 5 separate platforms by FTE.
            </div>
          </div>
        </div>
      ...
      <DocSection title="The ROI Anchor — Make Price Feel Small">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3 mb-4">
          ...
          <div className="bg-white border border-stone-200 rounded-lg p-4">
            ...
            <p className="text-[12px] text-stone-600 mt-1">The calculated value from the ROI builder — agency fee reduction, time savings, faster time-to-hire, eliminated Provider seat costs.</p>
          </div>
        </div>
...
about the budget timing?"`}
          ...
          <div className="bg-white border border-stone-200 rounded-xl p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h4 className="font-bold text-stone-900 text-[13px]">"We already pay for an Provider through our HRIS"</h4>
            </div>
